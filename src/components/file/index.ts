...
export { default as FileThumbnail } from './thumbnail/FileThumbnail';
export { default as DownloadButton } from './thumbnail/DownloadButton';
...
export { default as FileInvitedItem } from './FileInvitedItem';
