...
const _mock = {
  ...
  phone_number: (index: number) => phone_number[index],
  ...
  image: {
    cover: (index: number) =>
      `${window.location.origin}/assets/images/covers/cover_${index + 1}.jpg`,
    product: (index: number) =>
      `${window.location.origin}/assets/images/products/product_${index + 1}.jpg`,
    avatar: (index: number) =>
      `${window.location.origin}/assets/images/avatars/avatar_${index + 1}.jpg`,
  },
};
