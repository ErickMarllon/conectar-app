    ...
    items: [
      // USER
      {
        ...
        children: [
          ...
          { title: 'edit', path: PATH_DASHBOARD.user.editSlug },
      ...
      // ENTERPRISE
      {
        ...
        children: [
          { title: 'profile', path: PATH_DASHBOARD.enterprise.profile },
          { title: 'cards', path: PATH_DASHBOARD.enterprise.cards },
          { title: 'list', path: PATH_DASHBOARD.enterprise.list },
          { title: 'edit', path: PATH_DASHBOARD.enterprise.editSlug },
          { title: 'account', path: PATH_DASHBOARD.enterprise.account },
        ],
      },
      // E-COMMERCE
      {
